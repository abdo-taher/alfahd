...
export async function CredibilityStrip() {
  ...
  return (
    <section className="section-padding bg-white dark:bg-gray-950 overflow-hidden" aria-label={t("title")}>
      <div className="container-brand">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-[#434652] dark:text-gray-400 mb-10" style={{ fontSize: "18px", lineHeight: "1.8", fontWeight: 300 }}>
              {locale === "ar"
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-center gap-3 text-[#1a1b21] dark:text-gray-200 font-semibold">
